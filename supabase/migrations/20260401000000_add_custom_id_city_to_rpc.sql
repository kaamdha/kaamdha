-- Add custom_id and city to search RPC return types

DROP FUNCTION IF EXISTS search_workers_nearby(TEXT, GEOGRAPHY, INTEGER);
DROP FUNCTION IF EXISTS search_jobs_nearby(TEXT[], GEOGRAPHY, INTEGER);
